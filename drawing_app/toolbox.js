...
function Toolbox() {
    ...
    console.log('Loading icon:', icon);  // Debug
    var img = createImg(icon);  // Use createImg for better error handling
    var sideBarItem = createDiv('');
    sideBarItem.class('sideBarItem');
    sideBarItem.id(name + "sideBarItem");
    sideBarItem.parent('sidebar');
    img.parent(sideBarItem);  // Add img to div
    sideBarItem.mouseClicked(toolbarItemClick);
    console.log('Icon added for', name);
};
	...
	this.selectTool = function(toolName) {
		console.log("Selecting tool:", toolName); // Debug
